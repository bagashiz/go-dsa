...
func TestDoublyLinkedListAppendInt(t *testing.T) {
	testCases := []struct {
		input  []int
		want   []int
		length int
...
func TestDoublyLinkedListPrependInt(t *testing.T) {
	testCases := []struct {
		input  []int
		want   []int
		length int
...
func TestDoublyLinkedListInsertAtInt(t *testing.T) {
	type item struct {
		index int
		data  int
	}
...
func TestDoublyLinkedListRemoveInt(t *testing.T) {
	testCases := []struct {
		append []int
		remove []int
		want   []int
...
func TestDoublyLinkedListRemoveAtInt(t *testing.T) {
	testCases := []struct {
		append   []int
		removeAt []int
		want     []int
...
func TestDoublyLinkedListGetInt(t *testing.T) {
	testCases := []struct {
		append []int
		index  int
		want   int
